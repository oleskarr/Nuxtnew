<template>
      ...
      <div class="flex flex-wrap justify-start gap-4 p-6">
        ...
        >
          ...
          <div class="p-4 flex flex-col justify-between" style="height: 100%;">
            ...
            <NuxtLink :to="'/post/' + post.id" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
  Подробнее
  <svg class="rtl:rotate-180 w-3.5 h-3.5 ms-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 14 10">
    ...
    <!-- Кнопка для изменения ширины панели -->
    <button
      @click="togglePanelWidth"
      class="absolute top-1/2 transform -translate-y-1/2 bg-gray-300 hover:bg-gray-300 cursor-pointer rounded-full w-12 h-12 flex items-center justify-center transition-all duration-300"
