  ...
  <nav class="bg-white dark:bg-gray-800">
    <div class="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl p-4">
      ...
      <a href="/" class="flex items-center space-x-3 rtl:space-x-reverse">
        ...
        <span class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Новочти</span>
      </a>

      <!-- Поле поиска (скрыто на маленьких экранах) -->
      ...
      <!-- Кнопка гамбургер-меню (появляется на мобильных экранах) -->
      ...
      <!-- Мега-меню для десктопов -->
      <div id="mega-menu-full"
        class="items-center justify-between font-medium hidden w-full md:flex md:w-auto md:order-1">
        <ul class="flex flex-col p-4 md:p-0 mt-4 border border-gray-100 rounded-lg  md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <NuxtLink
              to="/"
...
<style scoped>
/* Дополнительные стили для кнопки поиска, если нужно */
</style>
